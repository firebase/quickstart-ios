...
class OtherAuthViewController: UIViewController {
    ...
    private func configureTextField() {
        ...
        textFieldTopConstraint = textField.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: constant)
    ...
    private func configureButton() {
        ...
        buttonTopConstraint = button.topAnchor.constraint(equalTo: textField.bottomAnchor, constant: constant)
    ...
    private func configureInfoLabel() {
        ...
        NSLayoutConstraint.activate([
            ...
            infoLabel.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 35),
        ...
        NSLayoutConstraint.activate([
            ...
            infoSymbol.trailingAnchor.constraint(equalTo: infoLabel.safeAreaLayoutGuide.leadingAnchor, constant: -5)
        ])
    }
