...
public extension MultimodalAttachment {
    ...
    static func validateFileType(url: URL) throws {
    ...
    static func validateMimeTypeMatch(url: URL, mimeType: String) throws {
    ...
    static func validatePhotoType(_ item: PhotosPickerItem) throws -> String {
...
public extension MultimodalAttachment {
    static func fromPhotosPickerItem(_ item: PhotosPickerItem) async throws
    ...
    static func fromFilePickerItem(from url: URL) async throws -> MultimodalAttachment {
    ...
    static func fromURL(_ url: URL, mimeType: String) async throws -> MultimodalAttachment {
        try validateFileType(url: url)
