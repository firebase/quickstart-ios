...
class LoginView: UIView {
    ...
    private func setupFirebaseLogoImage() {
        ...
        NSLayoutConstraint.activate([
            imageView.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: -55),
            imageView.bottomAnchor.constraint(equalTo: self.bottomAnchor, constant: 55),
    ...
    private func setupEmailTextfield() {
        ...
        NSLayoutConstraint.activate([
            emailTextField.leadingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leadingAnchor, constant: 15),
            emailTextField.trailingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.trailingAnchor, constant: -15),
            emailTextField.heightAnchor.constraint(equalToConstant: 45)
        ])
        
        let constant: CGFloat = UIDevice.current.orientation.isLandscape ? 15 : 50
        emailTopConstraint = emailTextField.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: constant)
    ...
    private func setupPasswordTextField() {
        ...
        NSLayoutConstraint.activate([
            passwordTextField.leadingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leadingAnchor, constant: 15),
            passwordTextField.trailingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.trailingAnchor, constant: -15),
    ...
    private func setupLoginButton() {
        ...
        NSLayoutConstraint.activate([
            loginButton.leadingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.leadingAnchor, constant: 15),
            loginButton.trailingAnchor.constraint(equalTo: self.safeAreaLayoutGuide.trailingAnchor, constant: -15),
            loginButton.heightAnchor.constraint(equalToConstant: 45),
            loginButton.centerYAnchor.constraint(equalTo: self.centerYAnchor, constant: 5)
        ])
    }
